...
<!-- Start top-drone-camera Area (hero section) -->
<section class="top-drone-camera-area section-gap">
    <div class="hero-content">
        <h1>Experience the Future of Flight</h1>
        <p>Unleash the power of cutting-edge drone technology.</p>
        <a href="drone.php" class="cta-button">Shop Now</a>
    </div>
</section>
...
<section class="product-card-section py-5">
    <div class="container-fluid">
    <div class="row text-center mb-4" id="scroll-section">
        <h2>BEST SELLING</h2>
        <p>Discover the top drones and cameras designed for every adventure</p>
    </div>
...
function handleScroll() {
    ...
    if (isElementInViewport(section)) {
        section.classList.add('visible'); // Add the visible class to trigger animation
    }
}
